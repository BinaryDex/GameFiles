    ...
    if (window.Proxy) {
        var h = XMLHttpRequest
            ...
            try {
                ...
                if (!b) {
                    ...
                    if (e) {
                        ...
                        b = f && "identity" != f ? e * a.CONTENT_ENCODING_MULTIPLE | 0 : e * a.CONTENT_ENCODING_MULTIPLE
                    }
                }
            } catch (p) {}
          ...
          , l = function(a, c) {
            var b = 0;
            return function(d) {
                if (d && (d instanceof ProgressEvent || a.no_type_check) && ("progress" == d.type || "load" == d.type || "loadend" == d.type))
                    if (0 == d.lengthComputable) {
                        var e = d;
                        d = new Proxy(d,{
                            get: function(c, d) {
                                return "lengthComputable" == d ? !0 : "loaded" == d ? (b || (b = k(a, e)),
                                a.loadFinished ? b : Math.min(e.loaded, b - 1)) : "total" == d ? (b || (b = k(a, e)),
                                b) : c[d]
                            }
                        })
                    } else
          ...
          , n = {
            set: function(a, c, b) {
                a.xmlHTTPRequestLengthComputable && 0 == c.indexOf("on") && a.xmlHTTPRequestLengthComputable.listeners[c.substr(2)] ? (a.xmlHTTPRequestLengthComputable.listeners[c.substr(2)].on && delete a.xmlHTTPRequestLengthComputable.listeners[c.substr(2)].on,
                b ? (a[c] = l(a.xmlHTTPRequestLengthComputable, b),
                a.xmlHTTPRequestLengthComputable.listeners[c.substr(2)].on = b) : a[c] = b) : a[c] = b;
                return !0
            },
            get: function(a, c) {
                ...
                : "removeEventListener" == c ? function() {
                    if (a.xmlHTTPRequestLengthComputable.listeners[arguments[0]])
                        for (var b = a.xmlHTTPRequestLengthComputable.listeners[arguments[0]].listeners, d = 0; d < b.length; ++d) {
                            if (b[d][1] == arguments[1])
                                return b = b.splice(d)[0],
                                a[c].call(a, arguments[0], b[0], arguments[2], arguments[3])
                        }
                    else
                        return a[c].apply(a, arguments)
                }
        ...
        window.XMLHttpRequest = function(a) {
            ...
            c.addEventListener("load", function(a) {
                if (!e.lengthComputable && (e.loadFinished = !0,
                e.latestProgress)) {
